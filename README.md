...
| **TARGET name does not exist but its parent directory does.** | TARGET File name assumed. Copy SOURCE contents to TARGET.| TARGET directory name assumed. Create TARGET directory. Copy SOURCE content to TARGET.. | Identical behavior to adjacent left hand cell. | Error |
